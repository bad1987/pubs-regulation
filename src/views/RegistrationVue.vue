        ...
        <div class="rounded-sm bg-white shadow-default dark:bg-boxdark w-2/4">
            <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <form>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="email" placeholder="Enter your email" v-model="email"
                                    :class="[emailError ? 'border-red-500' : '', 'w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary']" />
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            <input type="password" placeholder="Enter your password" v-model="password"
                                :class="[passwordError ? 'border-red-500' : '', 'w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary']" />
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input type="password" placeholder="Enter your password" v-model="repeatPassword"
                                :class="[repeatPasswordError ? 'border-red-500' : '', 'w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary']" />
                    ...
                    <div class="mb-4">
                        <label class="mb-2.5 block font-medium text-black dark:text-white">User Role</label>
                        <div class="relative">
                    ...
                    <div class="mb-4">
                        <label class="mb-2.5 block font-medium text-black dark:text-white">User Status</label>
                        <div class="relative">
                    ...
                    <button @click="register"
                        class="w-full cursor-pointer rounded-lg border border-primary bg-red-500 p-4 font-medium text-white transition hover:bg-opacity-90">
                        Sign Up
                    </button>
