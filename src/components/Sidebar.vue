          ...
          <ul class="space-y-2">
                ...
                <li v-else>
                  ...
                  <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                    ...
                    <li><RouterLink to="/" :class="{ 'dark:bg-gray-700 bg-green-100' : route.fullPath == '/'  }" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Zone</RouterLink></li>
