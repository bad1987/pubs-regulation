...
<template>
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul class="space-y-2">
                <li>
                    <RouterLink to="/DashBoard" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700" :class="{ 'dark:bg-gray-700 bg-gray-100' : route.fullPath == '/'  }">
                ...
                <li v-if="userRef.isAdmin">
                  <button type="button" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>{{ $t("users") }}</span>
                        <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                  </button>
                  <ul id="dropdown-example" class="hidden py-2 space-y-2">
                      <li>
                          <RouterLink to="/admin/users/vendors" v-if="userRef.isAdmin" :class="{ 'dark:bg-gray-700 bg-gray-100' : route.fullPath == '/admin/users/vendors'  }" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                            <span class="flex-1 ml-3 whitespace-nowrap">Vendors</span>
                          </RouterLink>
                      </li>
                      <li>
                          <RouterLink to="/admin/users/admins" v-if="userRef.isAdmin" :class="{ 'dark:bg-gray-700 bg-gray-100' : route.fullPath == '/admin/users/admins'  }" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                            <span class="flex-1 ml-3 whitespace-nowrap">Structure</span>
                          </RouterLink>
                      </li>
                  </ul>
                </li>
                ...
                <li v-else>
                  <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-layouts" id="multiLevelDropdownButton" data-collapse-toggle="dropdown-layouts">
                      ...
                      <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Structure</span>
                  ...
                  <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                    <li v-if="userRef.user && userRef.user.platform != null">
                      <RouterLink to="/platform-settings" :class="{ 'dark:bg-gray-700 bg-gray-100' : route.fullPath == '/platform-settings'  }" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">{{ userRef.platform.name }}</RouterLink>
                    </li>
                    <li><RouterLink to="/zones" :class="{ 'dark:bg-gray-700 bg-green-100' : route.fullPath == '/'  }" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Zone</RouterLink></li>
                    <li><RouterLink to="/" :class="{ 'dark:bg-gray-700 bg-green-100' : route.fullPath == '/'  }" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Quartier</RouterLink></li>
                    <li><RouterLink to="/" :class="{ 'dark:bg-gray-700 bg-green-100' : route.fullPath == '/'  }" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Emplacement</RouterLink></li>
                    <li><RouterLink to="/ListeAnnonceur" :class="{ 'dark:bg-gray-700 bg-blue-100' : route.fullPath == '/'  }" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Annonceur</RouterLink></li>
                ...
                <li v-if="userRef.isAdmin">
                  <RouterLink to="/platforms" :class="{ 'dark:bg-gray-700 bg-gray-100' : route.fullPath == '/platforms'  }" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <svg  class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"></path>
                    </svg>
                    <span class="flex-1 ml-3 whitespace-nowrap">Etats</span>
                  </RouterLink>
                </li>
                <li v-if="!userRef.isAdmin">
                ...
                <li v-if="!userRef.isAdmin">
                    <RouterLink to="/messages" :class="{ 'dark:bg-gray-700 bg-gray-100' : route.fullPath == '/messages'  }" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155"></path>
                        </svg>
                      <span class="flex-1 ml-3 whitespace-nowrap">Affichage</span>
                    </RouterLink>
                </li>
...
<!--  -->
                ...
                <!-- <li v-if="!userRef.isAdmin">
                  <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-layouts" data-collapse-toggle="dropdown-layouts">
                      ...
                      <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Parametres</span>
                      <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                      </svg>
                  </button>
                  <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                    ...
                    <li v-if="userRef.user && userRef.user.platform == null">
                      <RouterLink to="/api" :class="{ 'dark:bg-gray-700 bg-gray-100' : route.fullPath == '/api'  }" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">settings API </RouterLink>
                    </li>
                    <li>
                      <RouterLink to="/payment-method" :class="{ 'dark:bg-gray-700 bg-gray-100' : route.fullPath == '/payment-method'  }" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">payment_method</RouterLink>
                    </li>
                  </ul>
                </li> -->
            </ul>
