      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
          <button id="theme-toggle" type="button"
            ...
            <svg v-if="!isDark" @click="themeStore.changeMode()" id="theme-toggle-dark-icon" class="w-5 h-5"
              fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
            </svg>
            <svg v-if="isDark" @click="themeStore.changeMode()" id="theme-toggle-light-icon" class="w-5 h-5"
              fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <div class="flex items-center ml-3">
            <div>
              <button type="button"
                ...
                <img class="w-8 h-8 rounded-full" src="https://www.gravatar.com/avatar/5513489be4218baa9c0243ad4d4459d9?s=300"
                  alt="user photo">
              </button>
            </div>
            <div
              ...
              <ul class="py-1" role="none">
                <li>
                  <RouterLink to="/"
                    ...
                    role="menuitem">Tableau de bord</RouterLink>
                </li>
                <li>
          ...
          <div class="flex items-center ml-3 outline-none md:order-2">
            ...
            <span v-if="actual == 'en'">English</span>
            <span v-if="actual == 'de'">Deutsch</span>
          </button>
          <!-- Dropdown -->
          <div
